...
insert into student (id,name) values ( 13,'Heba Attalah');
insert into student (id,name) values ( 14,'Islam Taha');
insert into student (id,name) values ( 15,'Khaled Attia');
insert into student (id,name) values ( 16,'Nouran Mahmoud');
insert into student (id,name) values ( 17,'Mahmoud Ezz');
insert into student (id,name) values ( 18,'Marwa Gamal');
insert into student (id,name) values ( 19,'Muhammad Fawzy');
insert into student (id,name) values ( 20,'Waleed Adel');
insert into student (id,name) values ( 22,'Youmna Hafez');
insert into student (id,name) values ( 23,'Youssif Ebrahim');
insert into student (id,name) values ( 24,'Radwa Kamal');
